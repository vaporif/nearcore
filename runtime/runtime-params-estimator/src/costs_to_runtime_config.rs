...
fn estimation(cost: ExtCosts) -> Option<Cost> {
    Some(match cost {
        ...
        ExtCosts::yield_resume_base => Cost::YieldResumeBase,
        ExtCosts::yield_resume_byte => Cost::YieldResumeByte,
        ExtCosts::yield_resume_status_base => Cost::YieldResumeStatusBase,
